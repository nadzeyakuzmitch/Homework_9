...
def encode_url_to_filename(url):
    ...
    """
    sanitized_url = validate_and_sanitize_url(str(url)) # NADZEYA FIX, type, supposed to be sanitized_url
...
def decode_filename_to_url(encoded_str: str) -> str:
    ...
    decoded_bytes = base64.urlsafe_b64decode(encoded_str) # NADZEYA FIX, type, b6decode doesn't exist
